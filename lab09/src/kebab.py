...
from lab09.src.skewer import skewer_calories, skewer_vegan
...
def kebab_usage():
    ...
    print("Vegan - check if skewer is vegan")
...
def kebab_calories(kebab,args):
    print('Skewer has', skewer_calories(kebab.skewer), 'calories')

def kebab_vegan(kebab, args):
    if skewer_vegan(kebab.skewer) == True:
        print('Skewer has', skewer_calories(kebab.skewer), 'calories')
    else:
        print('Skewer contains meat')
